...
//         if (item.expiresAt) {
//             // const totalTime = item.expiresAt - item.createdAt;
...
//                     discount = 20;
//                     finalPrice = item.price - (item.price * 20) / 100;
//                 }
//             }
//         }
...
export const addItem = async (req, res) => {
    try {
        ...
        // const { name, category, foodType, price, expiryMinutes, stock } = req.body;
        const { name, category, foodType, price, discount, expiryMinutes, stock } = req.body;
