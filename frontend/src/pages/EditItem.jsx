...
//           if (remaining > 0) {
//             setExpiryMinutes(Math.floor(remaining));
//           }
//         }
...
//   return (
//     <div className="min-h-screen flex justify-center items-center p-6 bg-gradient-to-br from-[#fff9f6] to-[#f4fdf9]">
...
//       <div className="max-w-lg w-full bg-white shadow-2xl rounded-3xl p-10">
...
//             className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#ff4d2d]"
//           />
